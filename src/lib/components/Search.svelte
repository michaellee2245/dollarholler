...
<div class="relative flex w-full items-baseline">
	...
	<input
		...
		class="search w-full border-b-2 border-dashed border-b-pastelPurple bg-transparent font-sansSerif text-lg text-black outline-none focus:border-solid focus:border-b-lavenderIndigo md:w-[14rem] lg:w-72 lg:text-xl"
	/>
